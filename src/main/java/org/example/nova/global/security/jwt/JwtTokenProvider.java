package org.example.nova.global.security.jwt;
...
public class JwtTokenProvider {
    ...
    public String generateAccessToken(String email) {
        return Jwts.builder()
                ...
                .signWith(Keys.hmacShaKeyFor(secretKey.getBytes())) // SecretKey 사용
                .compact();
    }
    ...
    public boolean validateToken(String token) {
        try {
            Jwts.parserBuilder()
                    .setSigningKey(Keys.hmacShaKeyFor(secretKey.getBytes())) // SecretKey 사용
                    .build()
